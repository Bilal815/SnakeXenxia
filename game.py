...
class Game():
    ...
    def draw(self):
        ...
        # in here we'll draw our snake, grid, food and score
        self.drawGrid()
        self.drawWorm()
        self.drawApple()
    ...
    def displayGameOver(self):
        ...
        overRect.midtop = (Config.WINDOW_WIDTH / 3, gameRect.height + 10 + 25)
        ...
        self.checkForKeyPress() # clear out any key pressed in the event queue
        while True:
            if self.checkForKeyPress(): # clear event queue
                pygame.event.get()
                return
